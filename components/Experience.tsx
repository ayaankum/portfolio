export default function Component() {
    return (
      <div className="p-6 text-white max-w-5xl mx-auto">
        ...
        <div className="relative border-l-2 border-blue-500/50 pl-8 ml-4 [box-shadow:_-4px_rgb(59_130_246_/_50%)]">
          {/* First Position */}
          <div className="mb-12 relative">
            <div className="absolute -left-[45px] bg-slate-900 p-1 rounded-full border-2 border-blue-400 [box-shadow:_0_0_15px_rgb(59_130_246_/_50%)]">
