    ...
    >
      ...
      <div className="relative bg-slate-900 rounded-lg p-6 h-full border border-blue-500/20">
        <div className="flex flex-col items-center justify-center space-y-4">
          <div className="w-16 h-16 text-blue-400">{icon}</div>
          <h3 className="text-2xl font-bold text-blue-400 [text-shadow:_0_0_10px_rgb(59_130_246_/_50%)]">
            {title}
          </h3>
        </div>
      </div>
...
export default function Component() {
  const skills = [
    ...
    { title: "Spring Boot", icon: <Power className="w-full h-full" /> },
    { title: "PostgreSQL", icon: <Database className="w-full h-full" /> },
    {title: "Java" , 
      icon: (<svg viewBox="0 0 24 24" className="w-16 h-16 text-blue-400" fill="currentColor">
